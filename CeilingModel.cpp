...
CeilingModel::CeilingModel(int textureRow, int textureCol, double height) {
...
std::vector<int> CeilingModel::getFaces() {
    int fd[] = {1, 1, 0,
                2, 2, 0,
                0, 0, 0,
                3, 3, 0
...
std::vector<double> CeilingModel::getNormals() {
...
std::vector<double> CeilingModel::getUVs() {
...
std::vector<double> CeilingModel::getVertices() {
